...
def process_sentence(sentence):
    ...
    return word_count, title_case


# Task 2: Test case
input_sentence = "data science and ai are the future"
word_count, title_case_sentence = process_sentence(input_sentence)
...
# Task 2: Test case
test_list = [1, 2, 3, 4, 5, 6, 7.0, 8, 9.5, 10]
result = filter_even_numbers(test_list)
print("Even numbers:", result)

def extract_numeric_keys(data):
    """
    Task 1:
    - Accept a dictionary
    - Return a list of keys where the value is numeric (int or float)
    """
    if not isinstance(data, dict):
        return "Invalid input"

    numeric_keys = [key for key, value in data.items() if isinstance(value, (int, float))]
    return numeric_keys
...
result = extract_numeric_keys(test_data)
print("Numeric keys:", result)
...
class Car:
    ...
    - Add a method named describe_car() that prints "Year Make Model"
    """
...
# Task 2: Create a Car object and call describe_car
